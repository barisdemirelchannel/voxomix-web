#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# sitemap.xml'i tüm dillerle (tr/en/es/fr/de/it) yeniden üretir.
import os
...
# post-key -> {lang: slug}
POSTS = {
  'vocals':  {'tr':'sarkidan-vokal-ayirma','en':'how-to-remove-vocals-from-a-song','es':'como-quitar-la-voz-de-una-cancion','fr':'supprimer-la-voix-dune-chanson','de':'gesang-aus-einem-song-entfernen','it':'rimuovere-la-voce-da-una-canzone'},
...
POST_MOD = {'vocals':'2026-09-07','chords':'2026-09-06','instrument':'2026-09-06','pillar':'2026-07-17','slow':'2026-07-17','offline':'2026-07-17','howto':'2026-09-07'}
POST_PRIO = {'vocals':'0.8','chords':'0.8','instrument':'0.8','pillar':'0.9','slow':'0.8','offline':'0.8','howto':'0.8'}
...
for key, langs in POSTS.items():
    for lang in ['tr','en','es','fr','de','it']:
        mod = POST_MOD[key] if (lang in ('tr','en') or key in ('vocals','chords','instrument','howto')) else TODAY
